...
ap.add_argument("-t", "--target", required=False, default='train_data',
	help="path to output face detector")
ap.add_argument("-n", "--name", required=True,
	help="name of person for training")
...
while count < COUNT:
	...
	for i in range(0, detections.shape[2]):
		...
		if confidence > CONFIDENCE:
			...
			# if the `space` key was pressed, take a snap
			if key == ord(" "):
				file_name = '{}/{}_{}.jpg'.format(path, name, count)
